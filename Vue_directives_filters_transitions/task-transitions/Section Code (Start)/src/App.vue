...
.slide-enter {
  opacity: 0;
  /* transform: translateY(20px); nije potrebno jer ce se posli samo dodat */
}
.slide-enter-active {
...
.slide-leave {
  /* Pocetna lokacija je defaultna */
}
.slide-leave-active {
  animation: slide-out 1s ease-out forwards;
  transition: opacity 1s;
  opacity: 0;
  /* Radi removanja, da moze pomaknit item odma jedan iza drugog, a ne cekat uklanjanje */
  position: absolute;
}
/* transition group */
.slide-move {
